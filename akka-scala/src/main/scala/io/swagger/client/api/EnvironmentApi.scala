...
object EnvironmentApi {
  ...
  def getForecast(days: Int): ApiRequest[ForecastResponse] =
    ApiRequest[ForecastResponse](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/fabri-org/second-test-api/1.0.0", "/temperature/forecast/{days}", "application/json")
  ...
  def getHeaterState(zoneId: String): ApiRequest[HeaterState] =
    ApiRequest[HeaterState](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/fabri-org/second-test-api/1.0.0", "/temperature/{zoneId}/heater", "application/json")
  ...
  def getZoneTemperature(zoneId: String): ApiRequest[TemperatueZoneStatus] =
    ApiRequest[TemperatueZoneStatus](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/fabri-org/second-test-api/1.0.0", "/temperature/{zoneId}", "application/json")
      .withPathParam("zoneId", zoneId)
  ...
  def setHeaterState(zoneId: String, state: String): ApiRequest[ApiResponse] =
    ApiRequest[ApiResponse](ApiMethods.POST, "https://dev-virtserver.swaggerhub.com/fabri-org/second-test-api/1.0.0", "/temperature/{zoneId}/heater/{state}", "application/json")
      .withPathParam("zoneId", zoneId)
  ...
  def temperatureSummary(): ApiRequest[TemperatureSummary] =
    ApiRequest[TemperatureSummary](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/fabri-org/second-test-api/1.0.0", "/temperature", "application/json")
